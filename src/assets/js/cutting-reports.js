...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    try {
        ...
        if (typeof StorageAdapter !== 'undefined') {
            console.log('📦 Initializing StorageAdapter for cutting reports...');
            window.eecolDB = new StorageAdapter();
            await window.eecolDB.initialize();
            console.log('✅ StorageAdapter initialized successfully for cutting reports');
            ...
            console.warn('⚠️ StorageAdapter is not available. Falling back to localStorage for cutting reports.');
        }
